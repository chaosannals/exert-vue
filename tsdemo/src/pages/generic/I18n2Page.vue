...
type MyI18nItemFilter = {
    [P in keyof MyI18nItem as (`${P}_${MyI18nLang}` & keyof MyI18nItem) extends never ? never : P] : MyI18nItem[P]
};
type MyI18nItemParam = keyof MyI18nItemFilter;

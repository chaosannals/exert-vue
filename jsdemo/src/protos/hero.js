...
export const hero = $root.hero = (() => {
    ...
    hero.HeroService = (function() {
         ...
         * @param {hero.HeroService.FindOneCallback} callback Node-style callback called with the error, if any, and Hero
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(HeroService.prototype.findOne = function findOne(request, callback) {
        ...
        /**
         * Callback as used by {@link hero.HeroService#findMany}.
         * @memberof hero.HeroService
         * @typedef FindManyCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {hero.Hero} [response] Hero
         */
         ...
         * @instance
         * @param {hero.IHeroById} request HeroById message or plain object
         * @param {hero.HeroService.FindManyCallback} callback Node-style callback called with the error, if any, and Hero
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(HeroService.prototype.findMany = function findMany(request, callback) {
            return this.rpcCall(findMany, $root.hero.HeroById, $root.hero.Hero, request, callback);
        }, "name", { value: "FindMany" });
    ...
    hero.HeroById = (function() {
        ...
        HeroById.decode = function decode(reader, length) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.hero.HeroById();
        ...
        HeroById.fromObject = function fromObject(object) {
            if (object instanceof $root.hero.HeroById)
                return object;
            let message = new $root.hero.HeroById();
            if (object.id != null)
    ...
    hero.Hero = (function() {
        ...
        Hero.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.hero.Hero();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        Hero.fromObject = function fromObject(object) {
            if (object instanceof $root.hero.Hero)
                return object;
            let message = new $root.hero.Hero();
            if (object.id != null)
                message.id = object.id | 0;
            if (object.name != null)
